...
LRESULT CALLBACK TrataEventos(HWND hWnd, UINT messg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CREATE:{
		...
		hBmp2 = (HBITMAP)LoadImage(NULL, _T("logo2.bmp"), IMAGE_BITMAP, 100, 100, LR_LOADFROMFILE);	// Carregamos o BITMAP(Devolve um HANDLE Genérico)
		GetObject(hBmp2, sizeof(bmp2), &bmp2); //Buscar informação sobre este HANDLE do BITMAP
		...
		bmpDC2 = CreateCompatibleDC(hdc);	// Criamos uma cópia do Device Context
